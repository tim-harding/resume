...
#grid(
    ...
    grid.cell[
        ...
        Beyond just VR, I also have full-stack web development experience. On the front-end, I've written web apps using React and mobile apps with React Native, and I've shipped full-stack projects for freelance clients at T-Mobile and All Cylinders. On the back end, I've worked in Go, C\#, Node.js, and SQL. At Ten Gun Design, I built most of my software in C\#.
